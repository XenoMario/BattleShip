...
bool Battleships::Board::shot()
{
    Position pos;
    cout << "Enter x and y position of the shot" << endl;
    std::cin >> pos.x >> pos.y;
    while (pos.x > size || pos.y > size)
    {
        cout << "Provided position is out of the board" << endl;
        cout << "Please enter new position" << endl;
        std::cin >> pos.x >> pos.y;
    }

    if (table[pos.x][pos.y] == true)
    {
        cout << "Accurate hit!" << endl;
        return true;
    }
    else
    {
